...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('reports')->name('reports.')->group(function () {
        ...
        Route::get('/transactions/print-filtered', [ReportController::class, 'printFiltered'])->name('transactions.printFiltered');
    });
